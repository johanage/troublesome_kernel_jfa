...
if save_adv_noise:
    torch.save(adversarial_noise_image, os.getcwd() + "/adv_attack_dip/adv_noise_image_dip_x.pt")
...
fig.savefig(os.path.join(save_dir, "dip_x_orig_adv_noise_adv_rec.png"))
